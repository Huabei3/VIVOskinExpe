...
lastPart = 'male39i';
Dtype='summer';
save_folder = fullfile("ellip_pic\ellipse", lastPart,Dtype, "combined_attributes","90");
    ...
    for idx = 1:length(attributes)
        ...
        source_files = {source_file1, source_file2, source_file3,source_file4};
            ...
            if exist(source_file, 'file')
                ...
                y_center_all=[y_center_all;y_center];

                target_y=target_score*y_center;
                
                [target_ab(1,1),target_ab(1,2),target_ab(2,1),target_ab(2,2)] = ...
                    calculate_target_ab( par,target_score,"hue");
                [target_ab(3,1),target_ab(3,2),target_ab(4,1),target_ab(4,2)] = ...
                    calculate_target_ab( par,target_score,"chroma");

                contour(data2, data3, y, [target_y, 1], 'Linewidth', 1, ...
                    'Color', colors(idx, :), 'LineStyle', '-'); 
                
                scatter(target_ab(:,1),target_ab(:,2), 30,  'filled', ...
