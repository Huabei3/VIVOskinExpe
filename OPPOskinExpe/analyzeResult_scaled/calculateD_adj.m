function D = calculateD_adj(CCT, duv, Dtype,adjust_factor)
    % 输入参数：
    %   CCT - 一个列向量，表示色温（单位：K）
    ...
    elseif strcmp(Dtype, "summer_adjusted")
        D = adjust_factor*0.239 * 0.723 * (1 - 1116 ./ CCT);
    elseif strcmp(Dtype, 'zhai')
        D = 0.723 * (1 - 1116 ./ CCT + 8.64 * duv - 49266 * duv ./ CCT);
    elseif strcmp(Dtype, 'zhai_adjusted')
        D = adjust_factor*0.723 * (1 - 1116 ./ CCT + 8.64 * duv - 49266 * duv ./ CCT);
