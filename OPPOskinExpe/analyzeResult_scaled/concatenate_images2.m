function concatenate_images2(save_folder,n_col)
    % 读取输入目录中的所有JPG图片文件
    image_files=dir(fullfile(save_folder,"f","*.jpg"));
    image_files=[image_files;dir(fullfile(save_folder,"m","*.jpg"))];
