function [par,r,y] = my_ellipsoidfit_withL(cielab,zscore,colorcenter)
...
for t = 1:400
    ...
    a = lsqcurvefit(f,a0,xdata,ydata, ...
        [0,0,0,-inf,0,colorcenter(2)-5,colorcenter(3)-5,-inf], ...
        [2,30,30,inf,90,colorcenter(2)+5,colorcenter(3)+5,1],options);
