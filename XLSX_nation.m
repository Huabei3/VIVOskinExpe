...
for i_obs = 1:length(obs_types)
    ...
    for i_para = 1:n_para        
        for i_nation = 1:length(nations)
            ...
            nation_serial=strcat(num1str(i_nation),nation);
            ...
            for i_subject = 1:n_subjects
                ...
                for attribute = 1:length(attributes)
                    ...
                    para_file=fullfile("AnalyseResults1\efit2\50\nation", ...
                        obs_type_used,iOr,attribute_serial,nation_serial, ...
                        strcat(picnames_groups(i_para),".mat"));
                    Lab=[]
