function concatenate_images2(save_folder,n_col,output_file)
    ...
    for i = 1:num_images
        ...
        text_str=image_files(i).name(slashes1+1:slashes2-1);
    ...
    for i = 1:num_images
        ...
        font_size_labels = round(cols / 30);
        ...
        text_position_labels = [cols - font_size_number*9, rows - font_size_number*1.5];
        ...
        img_with_text = insertText(img_with_text, text_position_labels, labels{i}, ...
            'FontSize', font_size_number, 'TextColor', text_color_number, 'BoxOpacity', 0);
