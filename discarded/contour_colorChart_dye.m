...
attri_type = "all"; % Set to "pre" for Attribute 1 only, or "all" for Attributes 1-9
...
color_type = "scene"; % Options: "model", "nation", "attr", "scene"
num_colors = 20;
...
elseif strcmp(color_type, "scene")
    num_colors = 14+3; % Maximum number of scenes
end
...
hold off;
save_folder = fullfile("ellip_pic", Dtype,"combined_plots",attri_type,color_type);
