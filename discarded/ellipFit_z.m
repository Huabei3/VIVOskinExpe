...
for i_level=10:10:80
    ...
    Z_score_level=(score_level-mean(score_level,1))./std(score_level,0,1);
    p=sum(Z_score_level>0,2)./size(Z_score_level,2);
...
save("fitRes_z\fitRes_level.mat",'par_all','r_all','parNr_all',"y_all");
%%
%atan2d_360
