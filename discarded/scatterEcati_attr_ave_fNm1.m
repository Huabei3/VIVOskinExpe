            ...
            % for i_para = 1:21
                ...
                for i_obstype=1:4
                    ...
                    if exist('par_all_used', 'var')&&~isempty(par_all_used{i_obstype,i_gender})
                        ...
                        %     'MarkerFaceColor', colors(i_obstype, :));
                        attribute_char=char(attribute_serial);
                        text(par(4), par(5), ...
                            attribute_char(1:2), 'FontSize', 5, ...
                            'VerticalAlignment', 'middle','Color',colors(i_obstype, :));
                        hold on;
                    end
                    par_types(i_obstype,:)=par;

                end
                quiver(par_types(1,4), par_types(1,5), ...
                        par_types(2,4) - par_types(1,4), ...
                        par_types(2,5) - par_types(1,5), ...
                        0, 'Color','k', 'LineWidth', 0.5, ...
                        'MaxHeadSize', 0.1);
