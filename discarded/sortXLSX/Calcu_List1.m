...
% 定义保存的 Excel 文件名
output_filename = fullfile("AlalyseResults", lastPart, 'ellip_list_all.xlsx');
output_filename_no_theta = fullfile("AlalyseResults", lastPart, 'ellip_list_all_no_theta.xlsx'); % 不包含 theta 的文件
...
for attribute = [1, 2, 3, 4, 5, 6, 8, 9, 10]
    ...
    save_folder = fullfile("AlalyseResults",Dtype, lastPart, attribute_serial, "list");
...
disp(strcat(lastPart,lastPart_new,"所有 attribute 的结果已写入 Excel 文件。"));
