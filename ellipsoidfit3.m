...
if nargin < 3
    ...
    f = @(a,xdata)(1./(1+a(8)*exp(a(1)*sqrt((xdata(:,1)-a(5)).^2+a(2)*(xdata(:,2)-a(6)).^2+a(3)*(xdata(:,3)-a(7)).^2 ...
        +a(4)*(xdata(:,2)-a(6)).*(xdata(:,3)-a(7))))))...
    .*(((xdata(:,1)-a(5)).^2+a(2)*(xdata(:,2)-a(6)).^2+a(3)*(xdata(:,3)-a(7)).^2+a(4)*(xdata(:,2)-a(6)).*(xdata(:,3)-a(7)))>=0);
    ...
    for t = 1:500
        ...
        a = lsqcurvefit(f,a0,xdata,ydata,[0,-inf,-inf,-inf,0,0,0,0],[0,inf,inf,inf,20,20,100,1],options);
