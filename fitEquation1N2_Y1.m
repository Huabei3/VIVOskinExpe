...
f = @(a,xdata1)(a(1)*log10(116*(xdata1).^(1/3)-16)+a(2));
...
for t = 1:500
    ...
    y = a(1)*log10(116*(xdata1).^(1/3)-16)+a(2);
...
text(55,5,strcat('C*=',num2str(a(1)),'*log10((116*(Y)^3-16))+',num2str(a(2))), ...
...
% ydata=[ydata;0.0001];
f = @(a,xdata1)(a(1)*log10(116*(xdata1).^(1/3)-16)+ ...
    a(2)*log10(116*(xdata1).^(1/3)-16).^2+a(3));
...
for t = 1:500
    ...
    y = a(1)*log10(116*(xdata1).^(1/3)-16)+a(2)*log10(116*(xdata1).^(1/3)-16).^2+a(3);
...
text( 35,2,{'C*=',num2str(a(1)),'*log10(116*(Y)^3-16)+', ...
    num2str(a(2)),'*log10(116*(Y)^3-16)^2+', ...
