...
if isscalar(lastPart_types)
    output_folder = fullfile(save_folder,"color_chart_attr",iOr,obs_type,"a_b");
else
    output_folder = fullfile(save_folder,"color_chart_attr",obs_type,"a_b");
end
if ~exist(output_folder, "dir")
    mkdir(output_folder);
end
...
hold off;
if isscalar(lastPart_types)
    output_folder = fullfile(save_folder,"color_chart_attr",iOr,obs_type,"L_C");
else
    output_folder = fullfile(save_folder,"color_chart_attr",obs_type,"L_C");
end
if ~exist(output_folder, "dir")
    mkdir(output_folder);
end
