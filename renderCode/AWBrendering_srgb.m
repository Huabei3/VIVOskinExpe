function [actualwhite,rgbnew,ccT,duv,bull,bull1,ratio,lab,outxyz,center0,center1]=AWBrendering_srgb(img,mode,spq,w,dlab,option)
...
[lab,xyz,center0,bull,count,~]=mask(input,ellipse,white65,w,'srgb');%用于其他像素占据较大比重，同时与肤色差异很大时，初始椭球采用肤色椭球
...
%    disp([string,' not founded in memory ellipse, average center was used']);
   [lab,xyz,center0,bull,count1,~]=maskv2(input,ellipse,white65,w,'srgb');
end
...
%这里imgcat没有更改是因为AWBrendering的rgbnew对后续没有影响，只有actualwhite对后续有影响
rgbnew(rgbnew<0)=0;
