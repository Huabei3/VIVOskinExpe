...
datai_file='D:\oppoSkinExperi\memoryAWB-simplify\datai_sorted53_3.mat';
if matrix==1
    xyz=srgb2xyz(out);
end
if matrix==2
...
datafile='D:\oppoSkinExperi\memoryAWB-simplify\data_sorted53_3.mat';
rgbnew=lut3d_xyz2rgb1(xyz2,datafile,i,i_points);
