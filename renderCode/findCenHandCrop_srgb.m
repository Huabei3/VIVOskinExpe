...
files = dir('Z:\homes\Peggy\oppoSkinExperi\picked40\iphone\cropped\*.jpg');  % 读取文件夹中的所有.jpg文件
dir_mask=dir("Z:\homes\Peggy\oppoSkinExperi\picked40\iphone\cropped\mask\*.jpg");
dir_setPoints=dir(['Z:\homes\Peggy\oppoSkinExperi\picked40\iphone\cropped\' ...
    'discarded\setPoints07\setPoints*.mat']);
save_folder='Z:\homes\Peggy\oppoSkinExperi\picked40\iphone\cropped\aveSkinByHand';
...
%%
    ...
    save(fullfile(save_folder,strcat('autoNhand_srgb.mat')), ...
        'average_rgb_all','average_xyz_all','average_lab_all', ...
        'de_all',"de00_all","de00c_all");
