...
for i = 10:numel(files)
    ...
    for i_points=startCenter:endCenter
        ...
        img_file=['Z:\homes\Peggy\oppoSkinExperi\picked40\Hassel\downSampled1\cropped\renderedAdd\' ...
        ...
        imwrite(out_rendering,['Z:\homes\Peggy\oppoSkinExperi\picked40\Hassel\downSampled1\cropped\renderedAdd\' ...
            ,files(i).name(1:end-4),'_',sprintf('%02d', i_points),'[',num2str(dlab(1,1)),',' ,...
            num2str(dlab(1,2)),',',num2str(dlab(1,3)),'].jpg'] );
