...
%% 保存数据
save_folder = fullfile("ellip_pic_p_free", Dtype,"50",scale_type);
        ...
        % for attribute = 1:length(attributes)
            ...
            for i_nation = 1:length(nations)
                ...
                if ~all(isnan(p_group(:)))
                    [par, r, y] = my_ellipsoidfit3_free(lab_group, p_group);
                    ...
                    fitRes_folder=fullfile("AnalyseResults_p_free",Dtype,scale_type_origin,"50","nation_merge_HML", scale_type,...
