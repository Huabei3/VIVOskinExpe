function concatenate_images1(save_folder,n_col)
    ...
    for i = 1:num_images
        ...
        text_position_number = [cols - font_size_number*2, rows - font_size_number*4];
...
%%
% concatenate_images1("D:\work\VIVOskinExpe\analyze\ellip_pic_p\efit_p\compare_thesis_pre\exclude_this",4)